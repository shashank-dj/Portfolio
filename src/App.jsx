...
import JulesPM from './pages/caseStudies/Jules';
    ...
    <div className="min-h-screen flex flex-col bg-void text-zinc-100 font-jakarta">
      ...
      <main className="flex-grow">
        <Routes>
          ...
          <Route
            path="/case-studies/zomato"
            element={<ZomatoCaseStudy />}
          />

          <Route
            path="/case-studies/cargill"
            element={<CargillCaseStudy />}
          />

          <Route
            path="/case-studies/cursor-pm"
            element={<CursorPMCaseStudy />}
          />

          <Route
            path="/case-studies/jules"
            element={<JulesPM />}
          />
