      ...
      <div className="max-w-4xl mx-auto">
        <div className="border border-borderlight rounded-xl p-8 bg-white shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-textsub mt-6 leading-relaxed">
            Board ESG Intelligence is a governance-focused ESG decision intelligence
            platform designed for Private Equity firms and Boards of Directors.
            The product creates a system of record for board-level ESG decisions,
            enabling defensible evidence for Limited Partner (LP) reviews,
            regulatory scrutiny, and exit due diligence.
          </p>
          ...
          <div className="mt-8">
            ...
            <ul className="list-disc list-inside text-textsub space-y-2">
              <li>
                Identified a governance gap in how ESG decisions are documented
                at board level
              </li>
              <li>
                Designed the product architecture and end-to-end user flows
                focused on PE and board governance
              </li>
              <li>
                Built a multi-page React web application to showcase the product
                structure and capabilities
              </li>
              <li>
                Authored comprehensive product documentation covering problem
                framing, users, security, and roadmap
              </li>
              <li>
          ...
          {/* STACK */}
          <p className="text-sm text-textsub mt-6 font-semibold">
